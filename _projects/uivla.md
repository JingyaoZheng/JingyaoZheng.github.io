...
concentrate (~70%) in the *legibility* layer alone, with safety- or
functionality-critical placements failing in under 4% of cases.

*Dataset frames are not shown here pending data-use-agreement review; figures
in the eventual paper will follow the dataset licence.*
