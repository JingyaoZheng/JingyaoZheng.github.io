...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-back-to-work-from-chinese-new-year",
          ...
          description: "",
          section: "News",},{id: "news-working-on-iclr-2026-and-grf-now",
          title: 'Working on ICLR 2026 and GRF now.',
          description: "",
          section: "News",},{
        id: 'social-email',
        title: 'email',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0001-8920-308X", "_blank");
        },
      },{
        id: 'social-scholar',
